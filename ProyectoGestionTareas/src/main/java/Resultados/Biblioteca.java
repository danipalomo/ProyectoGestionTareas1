...
public class Biblioteca extends ResultadoTarea implements Serializable, Resultado {
    ...
    public Biblioteca(String lenguajeEmpleado, int numLineas, int numModulos) {
